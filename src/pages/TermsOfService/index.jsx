      ...
      <section className="py-20">
        <div className="container max-w-4xl px-4">
          <motion.div {...fadeUp(0)} className="prose prose-lg max-w-none text-gray-600 dark:text-gray-400">
            <p className="text-lg leading-relaxed mb-8">{tx.intro}</p>
            ...
            <div className="space-y-12">
              ...
              <section>
                ...
                <p className="leading-relaxed">{tx.s2p}</p>
              </section>
              <section>
                ...
                <p className="leading-relaxed mt-4">{tx.s3p2}</p>
              </section>
              <section>
                ...
                <p className="leading-relaxed mt-4">{tx.s4p3}</p>
              </section>
              <section>
              ...
              <section>
                ...
                <p className="leading-relaxed mb-4">{tx.s6p3}</p>
                <ul className="list-disc pl-6 space-y-2">{tx.s6li.map((item,i)=><li key={i}>{item}</li>)}</ul>
                <p className="leading-relaxed mt-4">{tx.s6p4}</p>
              </section>
              <section>
                ...
                <p className="leading-relaxed">{tx.s7p3}</p>
              </section>
              <section>
                ...
                <p className="leading-relaxed mb-4">{tx.s8p2}</p>
                <ul className="list-disc pl-6 space-y-2">{tx.s8li.map((item,i)=><li key={i}>{item}</li>)}</ul>
                <p className="leading-relaxed mt-4">{tx.s8p3}</p>
              </section>
              <section>
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2">{tx.s10li.map((item,i)=><li key={i}>{item}</li>)}</ul>
                <p className="leading-relaxed mt-4">{tx.s10p2}</p>
                <p className="leading-relaxed mt-4">{tx.s10p3}</p>
              </section>
              <section>
                <h2 className="text-2xl font-display font-bold text-gray-900 dark:text-white mb-4">{tx.s11Title}</h2>
                <p className="leading-relaxed mb-4">{tx.s11p1}</p>
                <p className="leading-relaxed mb-4">{tx.s11p2}</p>
                <p className="leading-relaxed">{tx.s11p3}</p>
              </section>
              <section>
                <h2 className="text-2xl font-display font-bold text-gray-900 dark:text-white mb-4">{tx.s12Title}</h2>
                <p className="leading-relaxed mb-4">{tx.s12p1}</p>
                <p className="leading-relaxed mb-4">{tx.s12p2}</p>
                <p className="leading-relaxed">{tx.s12p3}</p>
              </section>
              <section>
              ...
              <section>
                ...
                <p className="leading-relaxed mb-4">{tx.s14p1}</p>
                <p className="leading-relaxed mb-4">{tx.s14p2}</p>
                <p className="leading-relaxed">{tx.s14p3}</p>
              </section>
              <section>
                <h2 className="text-2xl font-display font-bold text-gray-900 dark:text-white mb-4">{tx.s15Title}</h2>
                <p className="leading-relaxed">{tx.s15p}</p>
              </section>
              <section>
                <h2 className="text-2xl font-display font-bold text-gray-900 dark:text-white mb-4">{tx.s16Title}</h2>
                <p className="leading-relaxed mb-4">{tx.s16p1}</p>
                <p className="leading-relaxed mb-4">{tx.s16p2}</p>
                <p className="leading-relaxed">{tx.s16p3}</p>
              </section>
              <section>
                <h2 className="text-2xl font-display font-bold text-gray-900 dark:text-white mb-4">{tx.s17Title}</h2>
                <p className="leading-relaxed mb-4">{tx.s17p1}</p>
                <p className="leading-relaxed">{tx.s17p2}</p>
              </section>
              <section>
                <h2 className="text-2xl font-display font-bold text-gray-900 dark:text-white mb-4">{tx.s18Title}</h2>
                <p className="leading-relaxed mb-6">{tx.s18p}</p>
