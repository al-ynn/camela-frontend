            ...
            <div className="space-y-12">
              ...
              <section>
                ...
                <div className="space-y-6">
                  <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6">
                    <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-3">{tx.c1Title}</h3>
                    <p className="leading-relaxed mb-3">{tx.c1p}</p>
                    <ul className="list-disc pl-6 space-y-1">{tx.c1li.map((item,i)=><li key={i}>{item}</li>)}</ul>
                    <p className="leading-relaxed mt-3 text-sm">{tx.c1note}</p>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6">
                    <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-3">{tx.c2Title}</h3>
                    <p className="leading-relaxed mb-3">{tx.c2p}</p>
                    <ul className="list-disc pl-6 space-y-1">{tx.c2li.map((item,i)=><li key={i}>{item}</li>)}</ul>
                    <p className="leading-relaxed mt-3 text-sm">{tx.c2note}</p>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6">
                    <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-3">{tx.c3Title}</h3>
                    <p className="leading-relaxed mb-3">{tx.c3p}</p>
                    <ul className="list-disc pl-6 space-y-1">{tx.c3li.map((item,i)=><li key={i}>{item}</li>)}</ul>
                  </div>
                  <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6">
                    <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-3">{tx.c4Title}</h3>
                    <p className="leading-relaxed mb-3">{tx.c4p1}</p>
                    <p className="leading-relaxed mb-3">{tx.c4p2}</p>
                    <p className="leading-relaxed text-sm">{tx.c4p3}</p>
                  </div>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-6 space-y-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">{tx.attn}</p>
